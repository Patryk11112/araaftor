package com.atakmap.android.plugintemplate.araaftorPlugin.orientation;
...
/**
 * SOURCE : https://github.com/ratana/rotation-vector-compass
...
public class OrientationCalculator {
    ...
    private ArrayList<Vector3> mVertices = new ArrayList<>(NUM_POINTS + 1);
