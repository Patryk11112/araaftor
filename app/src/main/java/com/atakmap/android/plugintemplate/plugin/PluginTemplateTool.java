...
import com.atakmap.android.plugintemplate.AraaftorDropDownReceiver;
...
public class PluginTemplateTool extends Tool implements ToolDescriptor {
    ...
    public Drawable getIcon() {
        return (context == null) ? null
                : context.getResources().getDrawable(R.drawable.ikonka);
    }
    ...
    public void onActivate(Activity arg0, MapView arg1, ViewGroup arg2,
        ...
        Intent i = new Intent(
                AraaftorDropDownReceiver.SHOW_PLUGIN);
